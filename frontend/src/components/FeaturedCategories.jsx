    ...
    <section className="py-14 px-2 lg:px-8">
      <style>{`
        @keyframes glowPulse {
          0%, 100% {
            box-shadow:
              0 0 6px rgba(211,211,211,1),
              0 0 14px rgba(211,211,211,0.3);
          }

          50% {
            box-shadow:
              0 0 12px rgba(211,211,211,1),
        ...
        {categories.map((item) => (
          ...
          >
            ...
            <button
              ...
              className="glow-btn absolute rounded-full border border-[#D3D3D3] bg-black/30 text-white tracking-widest whitespace-nowrap hover:bg-[#D3D3D3] hover:text-black transition-colors duration-300"
              style={{
